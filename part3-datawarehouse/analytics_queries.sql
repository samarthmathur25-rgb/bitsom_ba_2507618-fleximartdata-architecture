...
-- Business Scenario: "The CEO wants to see sales performance broken down by time 
-- periods. Start with yearly total, then quarterly, then monthly sales for 2024."
...
-- customers into 'High Value' (>₹50,000 spent), 'Medium Value' (₹20,000-₹50,000), 
-- and 'Low Value' (<₹20,000)."
-- Segments: High/Medium/Low value customers using CASE and CTE
-- ============================================================================
